var LANGUAGES = {
    ...
    "en": {
        audioList: [
            ...
            "asset/audio/en/en_1.mp3",
            "asset/audio/en/en_2.mp3",
            "asset/audio/en/en_3.mp3"
        ],
        texts: {
            "page-title": "Welcome to herta kuru~",
            "doc-title": "Kuru Kuru~",
            "page-descriptions": "The Herta for Herta, the <del>annoying</del> cutest genius Honkai: Star Rail character out there.",
        ...
        cardImage: "../image/card_en.jpg"
    }, "cn": {
        audioList: [
            "asset/audio/cn/gululu.mp3",
            "asset/audio/cn/gururu.mp3",
            "asset/audio/cn/转圈圈.mp3",
            "asset/audio/cn/转圈圈咯.mp3",
            "asset/audio/cn/要坏掉了.mp3"
        ],
        texts: {
            "page-title": "黑塔转圈圈",
            "doc-title": "咕噜噜~",
        ...
        audioList: [
            "asset/audio/jp/kuruto.mp3",
            "asset/audio/jp/kuru1.mp3",
            "asset/audio/jp/kuru2.mp3",
        ],
        texts: {
        ...
        cardImage: "../image/card_ja.jpg"
    },
    "kr": {
        audioList: [
            // TODO audio random weight
            "asset/audio/kr/kr_1.mp3",
            "asset/audio/kr/kr_2.mp3",
            "asset/audio/kr/kr_3.mp3"
        ],
        texts: {
    ...
    "id": {
        ...
        texts: {
            ...
            "doc-title": "Kuru Kuru~",
            "page-descriptions": "Nona Herta, sang Karakter Jenius <del>ngeselin</del> dari Honkai: Star Rail.",
...
(() => {
    ...
    function multiLangMutation() {
        ...
        refreshDynamicTexts()
        document.getElementById("herta-card").src = "asset/image/" + curLang.cardImage; // sets the image of element with id "herta-card" to the translated version in the selected language.
    }
                ...
                if (Array.isArray(audioList)) {
                    for (let i = 0; i < audioList.length; i++) {
                        ...
                        if (typeof url === "string" && url.endsWith(".mp3")) {
                            promises.push(loadAndEncode("asset/audio/" + url).then(result => dict[lang].audioList[i] = result));
                        }
                    }
                }
            }
    ...
    cacheStaticObj("asset/image/hertaa1.gif");
    cacheStaticObj("asset/image/hertaa2.gif");
    ...
    function animateHerta() {
        ...
        elem.src = cacheStaticObj(`asset/image/hertaa${random}.gif`);
    ...
    function addAvatar(socialLink, currentIcon) {
        if (!currentIcon.includes('https://')) {
            currentIcon = 'asset/credits/' + currentIcon;
        }
